...
from storyviz.maps import create_minecraft_village
from storyviz.village_spec import VillageSpec

# Import files you want
from storyviz.classes import StorySchematics
from storyviz.schematic_manager import SchematicManager
from storyviz.general_schematic_placer import GeneralSchematicPlacer 
from storyviz.story_schematic_placer import StorySchematicPlacer
...
def perform(level, box, options):
    ...
    print('Final Village Spec')
    for building_spec in village_spec.building_specs.values():
    ...
    print("Village built. Please enjoy :)")
...
def get_schematics_info(schematic_files):
    ...
    for i, schematic in enumerate(schematics):
        if schematic.Length < 160 or schematic.Width < 160:
